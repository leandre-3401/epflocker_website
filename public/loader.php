...
<?php
if (isset($_GET['idCasier'])) {
  $idCasier = $_GET['idCasier'];
 ...
 // echo "Le casier à ouvrir est " . $idCasier . "<br>";
  ...
  echo "Le paramètre typeaction n'a pas été transmis.";
}
...
<body>
    ...
    <div class="container">
    <div class="text">Le casier <?php echo($idCasier)?> est en cours d'ouverture...</div>
  </div>
  ...
  <div class="btncontainer">
    <a  class="load_button" id="load1" href="/?action=logout">
        Opération réussie </a>
...
$casier; 
echo("http://192.168.138.102:8080/power" .$casier .".html");
